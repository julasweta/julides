...
const schema = Joi.object({
    ...
    phone: Joi.string().required().messages({"string.empty": "Поле phone обов'язкове для заповнення", }),
...
const OrderForm = () => {
    ...
    return (
        <> <form className="form-orders" onSubmit={onSubmit}>
            <span>Залиште заявку, щоб обговорити проект з дизайнером. Ми зв’яжемося з вами, відповімо на всі питання і призначимо зустріч.</span>
